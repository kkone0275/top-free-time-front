<template>
  <q-card class="my-card">
      ...
      <q-card-section>
        ...
        <img class="avatar" :src="`https://source.boringavatars.com/beam/256/${name}?colors=colors=ffabab,ffdaab,ddffab,abe4ff,d9abff`">
      ...
      <q-dialog v-model="form.dialog" persistent>
        <q-card style="min-width: 600px;height: 700px;">
            <q-card-section class="flex">
              <img class="avatar-in" :src="`https://source.boringavatars.com/beam/256/${name}?colors=colors=ffabab,ffdaab,ddffab,abe4ff,d9abff`">
